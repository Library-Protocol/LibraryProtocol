...
const CustomizableCover: React.FC<CoverImageCustomizationProps> = ({ libraryName }) => {
  ...
  const getCoverStyles = () => {
    const containerStyles: React.CSSProperties = {
      ...
      width: '700px',
      height: '1000px',
      borderRadius: coverStyle === 'modern' ? '12px' : coverStyle === 'minimal' ? '4px' : '0px',
      overflow: 'hidden',
  ...
  return (
    <div className="w-full h-full flex flex-col space-y-8 p-8">
            <div className="w-full h-full flex flex-row space-x-8 p-8">
  {/* Left Column */}
  <div className="flex-1">
    <div style={containerStyles} className="shadow-lg">
